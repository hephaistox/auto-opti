...
(deftest bucket-range-test
  (is (= [3 4]
         (-> (opt-tb-aggregates/make-aggregator [#::opti{:start-bucket 0}
                                                 #::opti{:start-bucket 5
                                                         :step 2}])
             (sut/bucket-range 3)))
